...
if CoreGui:FindFirstChild("Yteam-warning") then
	CoreGui["Yteam-warning"]:Destroy()
end
...
local ServerLink = "https://whatsapp.com/channel/0029Vb6BLyrJ93wWcPM5Sw1c"
local WarnMessage = "⚠ Script ini sedang dalam perbaikan Harap bersabar dan cek update selanjutnya!"
